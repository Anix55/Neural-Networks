/* 
 Evolving Neural Network v5: Demolition Derby
...
void setup() {
  ...
  for (int i = 125; i < width-100; i += 50) { //135 125
    for (int j = 175 ; j < height-150; j += 50) { // 185 175
  ...
  numEnviroVerti = 4;
  enviroVerti = new ArrayList<Vec2>();
  enviroVerti.add(new Vec2(100, 150));
  enviroVerti.add(new Vec2(100, height-150));
  enviroVerti.add(new Vec2(width-100, height-150));
  enviroVerti.add(new Vec2(width-100, 150));
  enviroVerti.add(new Vec2(100, 150));

  enviro = new Environment(enviroVerti);
  ...
  cp5.addSlider("HI_LITE", 0, populationSize-1, 0, 10, height-20, 300, 10) //55
...
void draw() {
  ...
  if (MODE == "EVOLVE") {
    ...
    Population.get(HI_LITE).NN.render();
    fill(255);
